            ...
            <div className="mb-16">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {benefits.map((benefit, index) => (
                  ...
                  >
                    <h3 className="text-lg font-bold mb-2 text-teal-500 transition-colors duration-300 group-hover:text-teal-400">{benefit.title}</h3>
                    <p className="text-gray-300 text-sm transition-colors duration-300 group-hover:text-white">{benefit.description}</p>
                  </div>
                ))}
              </div>
            </div>
