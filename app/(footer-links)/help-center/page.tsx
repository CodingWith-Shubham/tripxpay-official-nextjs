                ...
                <div className="bg-gray-900/60 backdrop-blur-sm rounded-xl sm:rounded-2xl p-4 sm:p-6 md:p-8 border border-gray-800/50 transition-all duration-300 hover:border-teal-500/30 hover:shadow-xl hover:shadow-teal-500/10 relative overflow-hidden">
                    ...
                    <div className="space-y-3 sm:space-y-4">
                        ...
                        <div className="bg-teal-500/20 p-2 sm:p-3 rounded-lg mr-3 sm:mr-4 md:mr-6 transition-all duration-300 group-hover:scale-110 border border-teal-500/30 relative z-10 flex-shrink-0">
                            <svg className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 text-teal-400 transition-colors duration-300 group-hover:text-teal-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z" />
                            </svg>
                        </div>
                        <div className="relative z-10 flex-1 min-w-0">
                            <h3 className="font-semibold text-sm sm:text-base md:text-lg mb-1 group-hover:text-teal-400">Live Chat</h3>
                            <p className="text-xs sm:text-sm text-gray-400 group-hover:text-gray-300">Get instant help from our support team</p>
                        </div>
                        <svg className="w-4 h-4 sm:w-5 sm:h-5 text-gray-600 opacity-0 group-hover:opacity-100 transition-all duration-300 group-hover:translate-x-1 group-hover:text-teal-400 relative z-10 ml-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                        </svg>
                        </button>
                        ...
                        <div className="relative z-10 flex-1 min-w-0">
                            <h3 className="font-semibold text-sm sm:text-base md:text-lg mb-1 group-hover:text-teal-400">Email Support</h3>
                            <p className="text-xs sm:text-sm text-gray-400 group-hover:text-gray-300 break-all">tripxpay@gmail.com</p>
                        </div>
                        <svg className="w-4 h-4 sm:w-5 sm:h-5 text-gray-600 opacity-0 group-hover:opacity-100 transition-all duration-300 group-hover:translate-x-1 group-hover:text-teal-400 relative z-10 ml-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                        </svg>
                        ...
                        <div className="relative z-10 flex-1 min-w-0">
                            <h3 className="font-semibold text-sm sm:text-base md:text-lg mb-1 group-hover:text-teal-400">Call Support</h3>
                            <p className="text-xs sm:text-sm text-gray-400 group-hover:text-gray-300">+91 93152 24277</p>
                        </div>
                        <svg className="w-4 h-4 sm:w-5 sm:h-5 text-gray-600 opacity-0 group-hover:opacity-100 transition-all duration-300 group-hover:translate-x-1 group-hover:text-teal-400 relative z-10 ml-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                        </svg>
