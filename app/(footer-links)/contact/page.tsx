            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
              <div>
                ...
                <p className="text-gray-300 mb-8">
                  ...
                  hours. We're looking forward to hearing from you!
                </p>
                ...
                <div className="space-y-6">
                  <div className="flex items-start group">
                    ...
                    <div>
                      <h3 className="text-lg font-medium mb-1 transition-colors duration-300 group-hover:text-white">
                        Email Us
                      </h3>
              ...
              <div>
                <form
                  ...
                  className="bg-gray-900/80 backdrop-blur-sm rounded-lg p-8 border border-gray-800/50 transform transition-all duration-300 hover:bg-gray-900/90 hover:border-teal-500/30 hover:shadow-2xl hover:shadow-teal-500/10"
                >
                  ...
                  <div className="space-y-6">
                    <div className="group">
                      <label
                        htmlFor="name"
                        className="block text-sm font-medium text-gray-300 mb-1 transition-colors duration-300 group-hover:text-white"
                      >
                        Your Name
                      </label>
                      <input
