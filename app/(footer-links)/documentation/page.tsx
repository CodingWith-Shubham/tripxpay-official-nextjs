                        ...
                        >
                          ...
                          <div className="col-span-2">
                            <span className={`inline-block px-2 py-1 rounded text-xs font-mono ${
                              endpoint.method === "GET" ? "bg-blue-900/30 text-blue-300" :
                              endpoint.method === "POST" ? "bg-green-900/30 text-green-300" :
                              endpoint.method === "PATCH" ? "bg-yellow-900/30 text-yellow-300" :
                              endpoint.method === "DELETE" ? "bg-red-900/30 text-red-300" :
                    ...
                    {sdks.map((sdk, index) => (
                      ...
                      >
                        ...
                        <div className="flex space-x-3">
                          <a href={sdk.link} className="text-sm text-gray-400 hover:text-white flex items-center">
