  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const existence = fetch(
        `/api/checkmerchant?merchantid=${signInMerchant.user.uid}`,
        { method: "POST" }
      );
      toast.promise(existence, {
      ...
      console.log(
        "error while signin the merchat",
        errorSignIn.message.toLowerCase()
      );
      setError("Email or password wrong");
      toast.error(
        "Email or password wrong, If you don't have merchant account create first by clicking to sign up",
