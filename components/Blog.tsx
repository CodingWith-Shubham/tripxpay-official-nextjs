  ...
  return (
    ...
    >
      <div className="flex items-center mb-3">
        <span className="text-xs font-medium md:text-[18px] text-white bg-teal-500 bg-opacity-10 px-2 py-1 rounded group-hover:bg-opacity-20 group-hover:text-teal-400 transition-all duration-300">
          {post.category}
        </span>
        <span className="text-xs text-gray-400 ml-auto transition-colors duration-300 group-hover:text-gray-300">
