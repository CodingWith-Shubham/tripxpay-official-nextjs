...
const VerifiedPageSkeletonScreen: React.FC = () => {
  return (
    <div className="min-h-screen bg-gray-900 overflow-hidden">
      {/* Background gradients - same as verified/page.tsx */}
      ...
      <main className="relative z-10 pt-10 pb-20 px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6">
            ...
            {/* Document Section */}
            <div className="bg-gray-900/50 border border-gray-800 backdrop-blur-sm rounded-2xl p-6 shadow-2xl">
              <div className="w-full flex items-center justify-between p-4 rounded-lg hover:bg-gray-800/50 transition-colors">
            ...
            <div className="flex gap-4">
              <motion.div
                className="flex-1 h-14 bg-gradient-to-r from-[#00FFB4]/50 to-[#5EEAD4]/50 rounded-xl"
                animate={shimmerAnimate}
                style={{
                  background: shimmerBackground,
                  backgroundSize: "200% 100%",
